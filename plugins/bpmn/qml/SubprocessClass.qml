...
Rectangle { 
	...
	Line { 
		...
		y1: 21 * parent.height / 80
		x2: 1 * parent.width / 14
		y2: 59 * parent.height / 80
		visible: models.getProperties(ids, "transaction")== "true"
		color: "#000000"
		style: "solid"
		width: 0
	} 
	Line { 
		x1: 1 * parent.width / 5
		y1: 3 * parent.height / 32
		x2: 4 * parent.width / 5
		y2: 3 * parent.height / 32
		visible: models.getProperties(ids, "transaction")== "true"
		color: "#000000"
		style: "solid"
		width: 0
	...
	Line { 
		x1: 13 * parent.width / 14
		y1: 21 * parent.height / 80
		x2: 13 * parent.width / 14
		y2: 59 * parent.height / 80
		visible: models.getProperties(ids, "transaction")== "true"
		color: "#000000"
		style: "solid"
	...
	Line { 
		x1: 1 * parent.width / 5
		y1: 29 * parent.height / 32
		x2: 4 * parent.width / 5
		y2: 29 * parent.height / 32
		visible: models.getProperties(ids, "transaction")== "true"
		color: "#000000"
		style: "solid"
		width: 0
	...
	Curve { 
		...
		x: 50
		y: 120
		visible: models.getProperties(ids, "adHoc")== "true"
	}
	Curve { 
		fill: "#ffffff"
		style: "solid"
